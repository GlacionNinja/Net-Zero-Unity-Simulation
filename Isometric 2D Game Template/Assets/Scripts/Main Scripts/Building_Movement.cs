...
public class Building_Movement : MonoBehaviour {
    ...
    void Start()
    {
        ...
        if (transform.GetChild(0).tag == "Five")
        {
            ...
            NormalTile = GameObject.FindGameObjectWithTag("NormalTileFive");
            SelectedTile = GameObject.FindGameObjectWithTag("SelectedTileFive");
            height = 1;
        }
        ...
        if (transform.GetChild(0).tag == "Three")
        {
            ...
            NormalTile = GameObject.FindGameObjectWithTag("NormalTileThree");
            SelectedTile = GameObject.FindGameObjectWithTag("SelectedTileThree");
            height = 1f;
        }
                    ...
                    if (Input.GetAxis("Mouse X") != 0 || Input.GetAxis("Mouse Y") != 0)
                    {
                        ...
                        if (Physics.Raycast(ray2, out hit2))
                        {
                            ...
                            else if (moveable.gameObject.transform.GetChild(0).tag == "Four")
                            {
                                ...
                                moveable.transform.position = new Vector3((Mathf.RoundToInt(hit2.point.x * tile_unit)) / tile_unit - 0.18f, transform.position.y,
